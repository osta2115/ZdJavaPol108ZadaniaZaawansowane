...
class MeasurementConverterTest {
    ...
    void shouldConvertCentimetersToInches() {
        //when
        float result = converter.convert(2f,
    ...
    void shouldConvertCentimetersToInches_Function() {
        //when
        float result = converter.convert(2f,
                ConversionTypeWithFunction.CENTIMETERS_TO_INCHES.CENTIMETERS_TO_INCHES);
        //then
        assertThat(result).isEqualTo(0.78f);
    }
    ...
    void shouldConvertMilesToKilometers_Function() {
        //when
        float result = converter.convert(2f,
                ConversionTypeWithFunction.MILES_TO_KILOMETERS.MILES_TO_KILOMETERS);
        //then
        assertThat(result).isCloseTo(3.22f, Percentage.withPercentage(1));
    }
